...
app.post("/utcdatetime_resolver",function(req,res){
    ...
    console.log("Getting the date and time from the front-end which was firstly converted from locatime to UTC date time on front"+
    "with the help of .utcstring() method and then sent  to server is "+srvr_utcdatetime+"and used here inside date"+ 
    "constructor so that we can use the date methods and properties on it");
